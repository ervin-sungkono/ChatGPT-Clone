...
export default function InputField({ name, placeholder }){
    ...
    return(
        <div className="w-full flex flex-col gap-2 md:gap-3 items-center absolute bottom-0 left-0 px-4 pb-3 md:pb-6 bg-gradient-to-t from-gray-900/40">
            <div className="relative w-full flex py-3 md:py-4 pl-4 max-w-2xl lg:max-w-3xl bg-gray-700 rounded-xl shadow-xs border border-white/0 focus-within:border-white/30">
                <textarea 
                    name={name}
